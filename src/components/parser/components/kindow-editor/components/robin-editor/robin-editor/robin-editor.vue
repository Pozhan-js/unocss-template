<template>
  <view class="wrapper" :style="{ 'padding-top': keyboardHeight }">
    <robin-editor-header
      ...
      :labelCancel="labelCancel"></robin-editor-header>
    <view
    ...
    <view
      ...
      <block v-for="(t, i) in tools" :key="i">
        ...
        <view
          ...
          data-name="direction"
          :data-value="formats.direction === 'rtl' ? '' : 'rtl'"></view>
      </block>
    </view>
...
import { robinColorPicker } from "../robin-color-picker/robin-color-picker";
import { robinEditorHeader } from "../robin-editor-header/robin-editor-header";
export default {
  components: {
    uniPopup,
    robinColorPicker,
  ...
  methods: {
    ...
    openColor(e) {
      ...
      console.log("openColor", name, color, this.$refs.color);
    },
    colorChanged(e) {
      let label = "";
