...
<view>
  ...
  <view
    :class="[
      ...
      !border && (bodyTableLeft > 50 || headerTableLeft > 50) && 'scroll-left-fixed',
    ]">
                      ...
                      <template v-else>
                        ...
                        <view class="sorter-table" v-if="item.sorter">
                          <view
                            :class="[
                              'sorter-table-icon',
                              item.sorterMode === '_asc' && `sorting${item.sorterMode || ''}`,
                            ]"></view>
                          <view
                            :class="[
                              'sorter-table-icon',
                              item.sorterMode === '_desc' && `sorting${item.sorterMode || ''}`,
                            ]"></view>
                        </view>
                      </template>
                    </view>
        ...
        if (item.type === "img") {
          if (!item.width) {
            ...
            this.data.forEach(data => {
              if (data[item.name]) {
                let urls =
                  typeof data[item.name] === "string" ? [data[item.name]] : data[item.name];
