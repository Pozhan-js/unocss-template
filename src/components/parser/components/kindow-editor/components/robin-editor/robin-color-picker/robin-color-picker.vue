<template>
  <view class="content">
    <robin-editor-header
      class="head"
      @cancel="cancel"
      @save="confirm"></robin-editor-header>
    <view class="color-picker">
      ...
      <view class="hue-view" @touchstart="pickHue" @touchmove="pickHue"
        ><text
          class="anchor"
          :style="{ left: hueView.anchorLeft + 'px' }"></text
      ></view>
      <view
        class="color-view"
        ...
        <text
          class="anchor"
          :style="{
            top: colorView.anchorTop + 'px',
            left: colorView.anchorLeft + 'px',
          }"></text>
      </view>
    </view>
  </view>
...
<script>
import popup from '@/components/uni-popup/components/uni-popup/popup.js';
